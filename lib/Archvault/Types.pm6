...
constant %keymaps = Map.new(
    ...
    'apple-a1048-sv'                      => '"Apple USB keyboard model A1048 with keypad, plastic enclosure"',
    'apple-a1243-sv'                      => '"Apple USB keyboard model A1243 with keypad, aluminium enclosure"',
    'apple-a1243-sv-fn-reverse'           => '"Apple USB keyboard model A1243 with keypad, aluminium enclosure with reversed Apple keys"',
    'apple-internal-0x0253-sv'            => '"Apple USB internal keyboard/trackpad (ISO)"',
    'apple-internal-0x0253-sv-fn-reverse' => '"Apple USB internal keyboard/trackpad (ISO) with reversed Apple keys"',
    ...
    'bone'                                => '"German Neo2 console keymap (Bone version)"',
    ...
    'ca'                                  => '"Canadian multilingual keyboard"',
    ...
    'dvorak-no'                           => '"Norwegian Dvorak keymap"',
    ...
    'euro1'                               => '"Euro and cent"',
    'euro2'                               => '"Euro and cent"',
    'fa'                                  => '"Persian ISIRI-2901 Unicode console keyboard driver"',
    ...
    'koy'                                 => '"German Neo2 console keymap (Koy version)"',
    ...
    'mod-dh-ansi-us'                      => '"Console keymap for the Colemak Mod-DH layout (US, ANSI keyboard, Z angle mod)"',
    'mod-dh-ansi-us-awing'                => '"Console keymap for the Colemak Mod-DH layout (US, ANSI keyboard, A-Wing angle mod)"',
    'mod-dh-ansi-us-fatz'                 => '"Console keymap for the Colemak Mod-DH layout (US, ANSI keyboard, Fat-z angle mod)"',
    'mod-dh-ansi-us-fatz-wide'            => '"Console keymap for the Colemak Mod-DH layout (US, ANSI keyboard, Fat-z, Wide layout)"',
    'mod-dh-ansi-us-wide'                 => '"Console keymap for the Colemak Mod-DH layout (US, ANSI keyboard, Z angle mod, Wide layout)"',
    'mod-dh-iso-uk'                       => '"Console keymap for the Colemak Mod-DH layout (UK, ISO keyboard)"',
    'mod-dh-iso-uk-wide'                  => '"Console keymap for the Colemak Mod-DH layout (UK, ISO keyboard, Wide layout)"',
    'mod-dh-iso-us'                       => '"Console keymap for the Colemak Mod-DH layout (US, ISO keyboard)"',
    'mod-dh-iso-us-wide'                  => '"Console keymap for the Colemak Mod-DH layout (US, ISO keyboard, Wide layout)"',
    'mod-dh-matrix-us'                    => '"Console keymap for the Colemak Mod-DH layout (ortho/matrix keyboard, no angle mod)"',
    'neo'                                 => '"German Neo2 console keymap (default version)"',
    'neoqwertz'                           => '"German Neo2 console keymap (QWERTZ version)"',
    ...
    'se-latin1'                           => '"QWERTY keymap for use in Finland and Sweden"',
    ...
    'us1'                                 => '"US QWERTY keymap with two alt keys"',
...
constant %locales = Map.new(
    ...
    'ab_GE'                 => '"Abkhazian language locale for Georgia"',
    ...
    'C'                     => '"Locale for C locale in UTF-8"',
    ...
    'rif_MA'                => '"Tarifit language locale for Morocco"',
