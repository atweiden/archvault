...
If Archvault fails to connect to the Internet, after having connected to
...
Be sure `dnscrypt-proxy.socket` is not active, as it conflicts with
`dnscrypt-proxy.service` at runtime.
