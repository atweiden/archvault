...
<table>
  <tr>
    <td>Last tested</td>
    <td>2018-08-09 with <a href="https://www.archlinux.org/releng/releases/2018.08.01/">archlinux-2018.08.01-x86_64.iso</a></td>
  </tr>
</table>
...
- configures [dnscrypt-proxy][dnscrypt-proxy]
  ...
  - modify `/etc/resolv.conf` (see:
    [resources/etc/resolv.conf](resources/etc/resolv.conf))
